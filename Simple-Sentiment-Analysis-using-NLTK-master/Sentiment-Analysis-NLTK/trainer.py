...
# saving the 6000 most frequent words ( more words will usually give better results)
word_features = list(BOW.keys())[:6000]
...
# The keys are the words in word_features ( the 6000 most frequent words in our reviews)
